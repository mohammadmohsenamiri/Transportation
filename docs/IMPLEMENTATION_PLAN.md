...
این پیوست بخشی از فازهای متعهدشده ۰ تا ۱۷ بالا **نیست** و طبق قرارداد اجرای فاز (بخش «قرارداد اجرای فاز توسط Claude» در همین سند) و ممنوعیت صریح `CLAUDE.md` («خارج از فاز جاری feature آینده را scaffold نکن») نباید بدون تخصیص یک فاز مستقل و تأیید صریح مالک محصول کدنویسی یا migration شود. هدف این پیوست فقط ثبت این است که **اگر** این قابلیت در آینده به یکی از فازها اضافه یا به‌عنوان فاز جدید (مثلاً Phase 18) افزوده شود، معماری آن از پیش تصمیم‌گیری‌شده باشد.
