...
> پیش از پیاده‌سازی هر صفحه، ماک‌آپ‌های مرجع در [`docs/mockups/`](./mockups/README.md) بررسی شوند. زبان بصری، چیدمان و اجزای UI باید تا حد امکان با این ماک‌آپ‌ها همسو باشند؛ در صورت تعارض با قواعد الزام‌آور `CLAUDE.md` (RTL، بدون CDN، دسترس‌پذیری)، قواعد `CLAUDE.md` اولویت دارند.
