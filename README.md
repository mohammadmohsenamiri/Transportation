...
وضعیت فعلی: Phase 0، Phase 1 (ورود واقعی و پوسته محافظت‌شده)، Phase 2 (ساختار سازمانی چهارسطحی)، Phase 3 (انواع خودرو، نوع بار و ناوگان)، Phase 4 (نقشه داخلی و نمایش دفاتر/انبارها)، Phase 5 (مدیریت مسیر، CSV و ترسیم روی نقشه)، Phase 6 (تعریف مرسوله و مقصد) و Phase 7 (برنامه‌ریزی مأموریت از فرم) تکمیل شده‌اند.
