...
وضعیت فعلی: Phase 0، Phase 1 (ورود واقعی و پوسته محافظت‌شده)، Phase 2 (ساختار سازمانی چهارسطحی)، Phase 3 (انواع خودرو، نوع بار و ناوگان)، Phase 4 (نقشه داخلی و نمایش دفاتر/انبارها) و Phase 5 (مدیریت مسیر، CSV و ترسیم روی نقشه) تکمیل شده‌اند.
