...
وضعیت فعلی: Phase 0، Phase 1 (ورود واقعی و پوسته محافظت‌شده)، Phase 2 (ساختار سازمانی چهارسطحی)، Phase 3 (انواع خودرو، نوع بار و ناوگان) و Phase 4 (نقشه داخلی و نمایش دفاتر/انبارها) تکمیل شده‌اند.
