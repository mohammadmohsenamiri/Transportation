...
وضعیت فعلی: Phase 0، Phase 1 (ورود واقعی و پوسته محافظت‌شده) و Phase 2 (ساختار سازمانی چهارسطحی) تکمیل شده‌اند.
...
- `/organization` — مدیریت CRUD ساختار سازمانی چهارسطحی (دفتر کشوری/گروه/توزیع‌کننده/انبار)؛ فقط برای نقش Admin.
